...
JOINT_CALIBRATION = [
    ...
    ['shoulder_lift', 0.0, 0.97],     # Joint2: zero position offset, scale factor
    ['elbow_flex', 0.0, 1.05],        # Joint3: zero position offset, scale factor
    ['wrist_flex', 0.0, 0.94],        # Joint4: zero position offset, scale factor
    ['wrist_roll', 160.0, 0.5],        # Joint5: zero position offset, scale factor
...
def main():
    ...
    try:
        ...
        # Configure robot
        robot_config = SO101FollowerConfig(port=port, id="R12253412")
